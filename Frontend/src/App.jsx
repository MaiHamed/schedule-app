...
import CourseEditPanel from './components/CourseEditPanel';   // ← Added this
...
export default function App() {
  ...
  // Course Edit Panel State
  const [editingCourse, setEditingCourse] = useState(null);
  const [showEditPanel, setShowEditPanel] = useState(false);

  // Safe current semester
  ...
  const handleDeleteDraft = (id) => {
    ...
    const remainingDrafts = semesters.find(s => s.id === currentSemesterId)?.drafts || [];
    if (currentDraftId === id && remainingDrafts.length > 0) {
